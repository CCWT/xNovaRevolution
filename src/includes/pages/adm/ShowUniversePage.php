...
function ShowUniversePage()
{
	...
	if ($_REQUEST['action'] == 'delete' && !empty($_REQUEST['id']) && $_REQUEST['id'] != 1) {
		...
		$SQL = "INSERT INTO " . ALLIANCE . " (`id`, `ally_name`, `ally_tag`, `ally_owner`, `ally_register_time`, `ally_description`, `ally_web`, `ally_text`, `ally_image`, `ally_request`, `ally_request_waiting`, `ally_request_notallow`, `ally_owner_range`, `ally_ranks`, `ally_members`, `ally_stats`, `ally_diplo`, `ally_universe`) VALUES "; foreach ($Data['ALLIANCE'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . BANNED . " (`id`, `who`, `theme`, `who2`, `time`, `longer`, `author`, `email`, `universe`) VALUES "; foreach ($Data['BANNED'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . BUDDY . " (`id`, `sender`, `owner`, `active`, `text`, `universe`) VALUES "; foreach ($Data['BUDDY'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . CHAT . " (`messageid`, `user`, `message`, `timestamp`, `ally_id`, `universe`) VALUES "; foreach ($Data['CHAT'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . DIPLO . " (`id`, `owner_1`, `owner_2`, `level`, `accept`, `accept_text`) VALUES "; foreach ($Data['DIPLO'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . FLEETS . " (`fleet_id`, `fleet_owner`, `fleet_mission`, `fleet_amount`, `fleet_array`, `fleet_universe`, `fleet_start_time`, `fleet_start_id`, `fleet_start_galaxy`, `fleet_start_system`, `fleet_start_planet`, `fleet_start_type`, `fleet_end_time`, `fleet_end_stay`, `fleet_end_id`, `fleet_end_galaxy`, `fleet_end_system`, `fleet_end_planet`, `fleet_end_type`, `fleet_target_obj`, `fleet_resource_metal`, `fleet_resource_crystal`, `fleet_resource_deuterium`, `fleet_resource_darkmatter`, `fleet_target_owner`, `fleet_group`, `fleet_mess`, `start_time`, `fleet_busy`) VALUES "; foreach ($Data['FLEETS'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . MESSAGES . " (`message_id`, `message_owner`, `message_sender`, `message_time`, `message_type`, `message_from`, `message_subject`, `message_text`, `message_unread`, `message_universe`) VALUES "; foreach ($Data['MESSAGES'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . NOTES . " (`id`, `owner`, `time`, `priority`, `title`, `text`, `universe`) VALUES "; foreach ($Data['NOTES'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . SUPPORT . " (`ID`, `player_id`, `time`, `subject`, `text`, `status`, `universe`) VALUES "; foreach ($Data['SUPP'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . TOPKB . " (`id_owner1`, `angreifer`, `id_owner2`, `defender`, `gesamtunits`, `rid`, `fleetresult`, `time`, `universe`) VALUES "; foreach ($Data['TOPKB'] as $Key => $Row) {
		...
		$SQL = "INSERT INTO " . USERS_VALID . " (`id`, `username`, `cle`, `password`, `email`, `date`, `planet`, `ip`, `lang`, `universe`) VALUES "; foreach ($Data['USERS_VALID'] as $Key => $Row) {
